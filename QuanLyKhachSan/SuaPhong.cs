...
namespace QuanLyKhachSan
{
    public partial class SuaPhong : Form
    {
        ...
        {
            //mã phòng = id nhận được khi click trên datagridview
            id1 = id;
            InitializeComponent();
        }
        //click nút sửa phòng
        ...
        {
            using (QuanLyKhachSanEntities3 db = new QuanLyKhachSanEntities3())
            {
        ...
        private void SuaPhong_Load(object sender, EventArgs e)
        {
            using (QuanLyKhachSanEntities3 db = new QuanLyKhachSanEntities3())
            {
                ...
                var p1 = Phong.ToList();
                //show data ra textbox trong 2 groupbox phòng cần sửa và phòng sửa mới
